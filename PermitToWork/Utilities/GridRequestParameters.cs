    ...
    public class GridRequestParameters
    {
        ...
        internal void Populate()
        {
            if (HttpContext.Current != null)
            {
                ...
                this.Page = curRequest["page"] == null ? null as Nullable<int> : int.Parse(curRequest["page"]);
                this.PageSize = curRequest["pageSize"] == null ? null as Nullable<int> : int.Parse(curRequest["pageSize"]);
                this.Skip = curRequest["skip"] == null ? null as Nullable<int> : int.Parse(curRequest["skip"]);
                this.Take = curRequest["take"] == null ? null as Nullable<int> : int.Parse(curRequest["take"]);
